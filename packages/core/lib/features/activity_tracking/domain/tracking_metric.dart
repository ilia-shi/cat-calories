...
final class MetricValueFactory {
  static MetricValueInterface fromJson(Map<String, dynamic> json) {
...
abstract class MetricValueInterface {
  TrackingMetric get metric;

  Map<String, dynamic> toJson();
}

final class CountValue implements MetricValueInterface {
  @override
...
final class RepsValue implements MetricValueInterface {
  @override
...
final class DurationValue implements MetricValueInterface {
  @override
...
final class WeightValue implements MetricValueInterface {
  @override
...
final class DistanceValue implements MetricValueInterface {
  @override
...
final class CaloriesValue implements MetricValueInterface {
  @override
