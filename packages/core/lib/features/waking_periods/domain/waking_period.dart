class WakingPeriod {
  ...
  factory WakingPeriod.fromJson(Map<String, dynamic> json) => WakingPeriod(
        id: json['id'],
  ...
  double getCaloriesPerMinute() {
    return getCaloriesPerSecond() * 60;
  }

  double getCaloriesPerHour() {
    return getCaloriesPerMinute() * 60;
  }

  WakingPeriod setExpectedWakingDuration(Duration duration) {
